...
export const AuthOrb = styled.div<{ $position: "1" | "2" }>`
  position: absolute;
  border-radius: 9999px;
  filter: blur(110px);
  pointer-events: none;

  width: ${props => props.$position === "1" ? "420px" : "360px"};
  height: ${props => props.$position === "1" ? "420px" : "360px"};
  top: ${props => props.$position === "1" ? "-90px" : "auto"};
  right: ${props => props.$position === "2" ? "-70px" : "auto"};
  bottom: ${props => props.$position === "2" ? "-70px" : "auto"};
  left: ${props => props.$position === "1" ? "-90px" : "auto"};
  background: ${props => props.$position === "1" ? "rgba(201, 169, 0, 0.1)" : "rgba(82, 96, 105, 0.12)"};
`;
...
export const DestinationChip = styled(motion.span)`
  display: inline-flex;
  align-items: center;
  gap: 6px;
  padding: 6px 12px;
...
export const SubmitBtn = styled.button`
  ...
  &:hover:not(:disabled) {
    box-shadow: 0 8px 24px rgba(201, 169, 0, 0.35);
